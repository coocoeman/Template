<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Template.Login" %>
					...
					<div class='section-block contact-block' >
						...
						<div class='container-fluid' >
							...
							<div class='section-header' >
								<h2>快登入來打遊戲吧 <strong class='color' >登入</strong></h2>
							</div>
